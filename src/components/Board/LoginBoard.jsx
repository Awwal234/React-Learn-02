  ...
  return (
    <>
        <div className="mx-auto py-[65px] px-[79px] loginsheetShadow bg-[#fff] rounded-[10px] mt-[51px] w-[552px]">
            ...
            {/* login button */}
            <div className="capitalize mb-[22px] cursor-pointer underline leading-[27.2px] text-[#62637C] font-[500] text-[15px] text-center mx-auto w-fit">
                forgot your password?
            </div>
            <div className="flex mx-auto w-fit space-x-[9px] items-center">
                <div className="capitalize text-[#62637C] font-[500] text-[15px]">no account yet?</div>
                <Link to='/create-account'><div className="text-[15px] cursor-pointer font-[500] text-[#60A3F0] underline capitalize">
                    create account
                </div></Link>
            </div>
        </div>
